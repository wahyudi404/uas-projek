<div class="px-4">
    ...
    <div id="preview" class="mx-auto border">
        <div style="font-family: 'Times New Roman'; font-size: 1vw;">
            ...
            <p style="text-align: center;">Nomor: <span style="margin-left: 2em;">/UNIWARA.5/KM/<?= $data['surat']['tahun_sekarang'] ?></span></p>
            ...
            <table style="margin-left: 2em;" class="table-report" border="0">
                ...
                <tr>
                    ...
                    <td>:S1 - <?= $data['surat']['program_studi'] ?></td>
                </tr>
                <tr>
            ...
            <p>
                Demikian surat keterangan ini digunakan <?= $data['surat']['kegunaan'] ?>
            </p>
        </div>
    </div>
