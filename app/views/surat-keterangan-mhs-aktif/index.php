                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4 item-list">
                    <div class="card text-decoration-none" style="height: 100%;">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="mb-4">
                                <h5 class="card-title" data-bs-toggle="tooltip" title="<?= $row['kegunaan'] ?>">
                                    <a href="<?= BASE_URL . $data['page'] ?>/detail/<?= $row['id'] ?>" class="text-decoration-none"><?= $row['kegunaan'] ?></a>
                                </h5>
                                <h6 class="card-subtitle text-muted"><?= $row['nim'] ?> - <?= $row['nama'] ?></h6>
                ...
                <form action="<?= BASE_URL . $data['page'] ?>/store" method="post">
                    <div class="row">
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <textarea name="kegunaan" class="form-control" id="kegunaan" required cols="15" rows="5"></textarea>
                        </div>
                    </div>
            </div>
