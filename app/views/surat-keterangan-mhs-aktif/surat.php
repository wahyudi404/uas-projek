...
<body>
    <div class="mx-auto" style="line-height: 1.5;">
        <div style="font-family: 'Times New Roman'; font-size: 14px;">
            ...
            <p style="text-align: center;">: <span style="margin-left: 3em;">/UNIWARA.5/KM/{{tahun_sekarang}}</span></p>
            ...
            <p>
                Demikian surat keterangan ini digunakan {{kegunaan}}
            </p>
        </div>
    </div>
